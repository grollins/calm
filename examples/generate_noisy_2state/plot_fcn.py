...
def plot_clean_vs_noisy(clean_ts, noisy_ts, output_image_path):
        mp = MultipanelPlot(2, 1, figsize=(12,8))

        # ===========
        # = Panel 1 =
        # ===========
        ax = mp.get_new_ax()
        ax.plot(clean_ts.series.index, clean_ts.series, '-', lw=2,
                color='k')
        ...
        # ===========
        ax = mp.get_new_ax()
        ax.plot(noisy_ts.series.index, noisy_ts.series, '-', lw=LINEWIDTH,
